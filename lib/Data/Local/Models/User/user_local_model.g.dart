...
const UserLocalModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'serverAuthCode': PropertySchema(
      id: 3,
      name: r'serverAuthCode',
      type: IsarType.string,
    )
  },
...
int _userLocalModelEstimateSize(
  ...
  {
    final value = object.serverAuthCode;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
void _userLocalModelSerialize(
  ...
  writer.writeString(offsets[3], object.serverAuthCode);
}
...
UserLocalModel _userLocalModelDeserialize(
  ...
  object.serverAuthCode = reader.readStringOrNull(offsets[3]);
  return object;
}
...
extension UserLocalModelQueryFilter
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      serverAuthCodeIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'serverAuthCode',
      ));
    });
  }

  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      serverAuthCodeIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'serverAuthCode',
      ));
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      serverAuthCodeContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'serverAuthCode',
        value: value,
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      serverAuthCodeMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'serverAuthCode',
        wildcard: pattern,
...
extension UserLocalModelQuerySortBy
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterSortBy> sortByPhotoUrl() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterSortBy>
      sortByServerAuthCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'serverAuthCode', Sort.asc);
    });
  }

  QueryBuilder<UserLocalModel, UserLocalModel, QAfterSortBy>
      sortByServerAuthCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'serverAuthCode', Sort.desc);
    });
  }
}
...
extension UserLocalModelQuerySortThenBy
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterSortBy> thenByPhotoUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'photoUrl', Sort.asc);
    });
  }
...
extension UserLocalModelQueryWhereDistinct
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QDistinct> distinctByDisplayName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QDistinct> distinctByPhotoUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QDistinct>
      distinctByServerAuthCode({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'serverAuthCode',
          caseSensitive: caseSensitive);
    });
  }
}
...
extension UserLocalModelQueryProperty
  ...
  QueryBuilder<UserLocalModel, String, QQueryOperations> displayNameProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, String?, QQueryOperations> photoUrlProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, String?, QQueryOperations>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'serverAuthCode');
    });
  }
}
